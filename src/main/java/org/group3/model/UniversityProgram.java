...
public class UniversityProgram {
    ...
    public UniversityProgram(String name, String university, String degree, String ouacProgramCode, String gradeRange, String experientialLearning, String enrollment, String instructionLanguage, List<String> prerequisites, String notes) {
        this.name = name;
    ...
    public String toString() {
        return "UniversityProgram{" +
                ...
                ", degree='" + degree + '\'' +
                ", ouacProgramCode='" + ouacProgramCode + '\'' +
