...
public class DisplayPanel extends JPanel {
  ...
  private ArrayList<UniversityProgram> universityProgramArray =
      (ArrayList<UniversityProgram>) DataModel.universityProgramArrayList;
  ...
  public DisplayPanel() {
    ...
    //// universityArray.get(i).setBounds(10+positionX*220+positionX*10,10+300*positionY
    //// +10*positionY,220,300);
  ...
  public void addUniversityPanels() {
    ...
    for (int i = 0; i < DataModel.universityProgramArrayList.size(); i++) {
      ...
      // Image sizeToFit =
      // LogoInput.imageMap.get(universityArray.get(i).getProgram().getUniversity()).getImage().getScaledInstance(universityArray.get(i).getUniversityButton().getWidth(),universityArray.get(i).getUniversityButton().getHeight(),
      // Image.SCALE_SMOOTH);
      // universityArray.get(i).getUniversityButton().setIcon(new
      // ImageIcon(sizeToFit));
      ...
      // getUniversityArray().get(i).getProgram().getUniversity() + ".jpg";
      // String imagePathPng = "assets/data/UniLogos/" +
      // getUniversityArray().get(i).getProgram().getUniversity() + ".png";
  ...
  public void sort(int type, int priority) {
    ...
    if (priority == 0) {
      if (type == 0) {
        ...
        Collections.sort(
            sortedArray,
            new Comparator<UniversityPanel>() {
        ...
        // a.getProgram().getUniversity().compareTo(b.getProgram().getUniversity()));
        // updateUniversityPanels(universityArray);
        sortedArray.sort(
            (a, b) -> a.getProgram().getUniversity().compareTo(b.getProgram().getUniversity()));
        updateUniversityPanels(sortedArray);
